...
class PPTProcessor:
    ...
    def clean_unused_layouts(self) -> int:
        ...
        try:
            ...
            try:
                ...
                print(f"使用中的设计: {used_designs}")
                print(f"使用中的布局: {used_layouts}")
    ...
    def get_image_processor(self) -> ImageProcessor:
        ...
        if not hasattr(self, '_image_processor'):
            ...
            # 确保数据库被初始化
            self._image_processor.init_database()
